...
$(function () {
  ...
  $(".popup-2").click(function () {
      // var $id = $(this).attr("id");
      // if($id === "gemi3"){
      //   var $src = "./assets/images/faq-area/gemi-3popup.jpg";
      // }
      // else if($id === "gemi2"){
      //   var $src = "./assets/images/faq-area/gemi-2popup.jpg";
      // }
      // else if($id === "gemi1"){
      //   var $src = "./assets/images/faq-area/gemi-1popup.jpg";
      // }
        var $src = $(this.children[0]).attr("src");
      $(".show-2").fadeIn();
      $(".img-show-2 img").attr("src", $src);
  });
  
  $(".popup-kapat-item, .overlay-2").click(function () {
      $(".show-2").fadeOut();
  });
...
const video = document.querySelector("#video_item");
playButton.addEventListener("click", ()=>{
  video.src = "./assets/videos/tugana.mp4";
...
document.addEventListener("click",(e)=>{
    if(e.target.className === "video_container videoActive"){
      videoContainer.classList.remove("videoActive");
      video.src = "";
    }
});
...
const hide_more_btn = document.querySelector("#hide_more_btn");
const read_more = document.querySelector("#read_more");

read_more_btn.addEventListener("click",()=>{
  read_more.classList.toggle("active_read_more");
  hide_more_btn.classList.toggle("active_read_more");
  read_more_btn.classList.toggle("active_read_more");
});

hide_more_btn.addEventListener("click",()=>{
  read_more.classList.toggle("active_read_more");
  hide_more_btn.classList.toggle("active_read_more");
  read_more_btn.classList.toggle("active_read_more");
});
